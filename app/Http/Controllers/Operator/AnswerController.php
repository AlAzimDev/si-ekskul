...
class AnswerController extends Controller
{
    public function index(){
        ...
        return view('operators.jawaban.index', compact('soals'));
    }
        ...
        try {
            ...
            if($timeNow->diff(Soal::find($id)->waktu_berhenti)->format('%r') == "-"){
                ...
                if($soal->count() > 0){
                    ...
                    return view('operators.jawaban.user-jawaban', compact('users','id','judul_soal'));
                }
            }else{
        ...
        try {
            ...
            if($timeNow->diff(Soal::find($id)->waktu_berhenti)->format('%r') == "-"){
                ...
                if($users->count() > 0){
                    ...
                    return view('operators.jawaban.jawaban', compact('answers2'));
                }
                return abort(500);
            }else{
                alert()->warning('Maaf','Sesi menjawab soal belum selesai');

...
class AbsensiController extends Controller
{
    public function index()
    {
        ...
        return view('operators.absensi.index', compact('absensi','lastabsensi','url'));
    }
    ...
    public function detail($id,$materi_pembelajaran){
        try {
            ...
            // dd($dataabsen);
            return view('operators.absensi.detail-absensi', compact('dataabsen','id','materi_pembelajaran'));
        } catch (Exception $e){
            return abort('404');
        }
    }

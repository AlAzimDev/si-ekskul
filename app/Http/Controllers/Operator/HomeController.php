...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('operators.index', compact('users','jumlah_users','jumlah_useradmin','jumlah_userpetugas','jumlah_usersiswa','nama_bulans','nilai_NULL','nilai_NOTNULL','role0','role1','role2'));
    }
    public function home()
    {
        ...
        $home   = Home::all();
        return view('operators.home',compact('random','home'));
    }

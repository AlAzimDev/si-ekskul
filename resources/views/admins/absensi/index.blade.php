                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body card-block">
                            ...
                            <div class="col col-md-12" align="center">
                                <button class="btn btn-primary col-md-3" onclick="copyFunction()">Copy</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body card-block">
                            <form method="post" id="form2" class="form-horizontal" action="{{route('admin-absensi-download')}}" >
                                @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3">

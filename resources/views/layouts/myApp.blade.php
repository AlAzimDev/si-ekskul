      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> by DonutTimAmpga | <a href="http://sister.smkn2guguak.sch.id" target="_blank">SMK Negeri 2 Guguak</a></p>
          </div>
        </div>
      </div>
    </footer>
